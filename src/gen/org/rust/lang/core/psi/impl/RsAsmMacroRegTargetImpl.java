...
public class RsAsmMacroRegTargetImpl extends RsElementImpl implements RsAsmMacroRegTarget {

  public RsAsmMacroRegTargetImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RsVisitor visitor) {
    visitor.visitAsmMacroRegTarget(this);
  }
