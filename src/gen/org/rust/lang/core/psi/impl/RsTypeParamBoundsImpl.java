...
public class RsTypeParamBoundsImpl extends RsStubbedElementImpl<RsPlaceholderStub> implements RsTypeParamBounds {

  public RsTypeParamBoundsImpl(ASTNode node) {
    super(node);
  }

  public RsTypeParamBoundsImpl(RsPlaceholderStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
