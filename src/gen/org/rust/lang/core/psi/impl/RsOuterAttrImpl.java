...
public class RsOuterAttrImpl extends RsStubbedElementImpl<RsPlaceholderStub> implements RsOuterAttr {

  public RsOuterAttrImpl(ASTNode node) {
    super(node);
  }

  public RsOuterAttrImpl(RsPlaceholderStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
