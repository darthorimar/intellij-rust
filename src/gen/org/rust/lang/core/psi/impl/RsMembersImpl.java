...
public class RsMembersImpl extends RsStubbedElementImpl<RsPlaceholderStub> implements RsMembers {

  public RsMembersImpl(ASTNode node) {
    super(node);
  }

  public RsMembersImpl(RsPlaceholderStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
