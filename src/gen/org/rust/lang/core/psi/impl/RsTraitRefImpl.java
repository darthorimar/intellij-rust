...
public class RsTraitRefImpl extends RsStubbedElementImpl<RsPlaceholderStub> implements RsTraitRef {

  public RsTraitRefImpl(ASTNode node) {
    super(node);
  }

  public RsTraitRefImpl(RsPlaceholderStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
